...
class RequestBorrowEquipmentType extends CActiveRecord
{
	...
	{
		return 'request_borrow_equipment_type';
	}
	...
	public function relations()
	{
		...
		return array(
				'request_borrow' => array(self::BELONGS_TO, 'RequestBorrow', 'request_borrow_id'),
