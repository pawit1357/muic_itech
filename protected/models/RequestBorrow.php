...
class RequestBorrow extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
				...
				'approver1' => array(self::BELONGS_TO, 'UserLogin', 'approver1'),
				'approver2' => array(self::BELONGS_TO, 'UserLogin', 'approver2'),
	...
	public function rules() {
		...
		return array(
				...
				array('event_type_id, location, approve_by, chef_email, description, from_date, thru_date,DocumentNo,remark,otherDevice,approver1,approver2,mobile_phone', 'safe'),
		);
	}
...
// 			echo "9::".$this->startDateFrom;
		...
		if(isset($this->status_for_approve) && $this->status_for_approve) {
			echo " approve_by = '".UserLoginUtil::getUserLoginId()."' OR approver1 = '".UserLoginUtil::getUserLoginId()."' OR approver2 ='".UserLoginUtil::getUserLoginId()."'";
			$criteria->addCondition(" approve_by = '".UserLoginUtil::getUserLoginId()."' OR approver1 = '".UserLoginUtil::getUserLoginId()."' OR approver2 ='".UserLoginUtil::getUserLoginId()."'");// and status_code in ('R_B_NEW_WAIT_APPROVE_1','R_B_NEW_WAIT_APPROVE_2') ");
		}
	...
	public function searchWattingApprove()
	{
		$criteria = new CDbCriteria;
// 		$criteria->addCondition(" approve_by = '".UserLoginUtil::getUserLoginId()."' OR approver1 = '".UserLoginUtil::getUserLoginId()."' OR approver2 ='".UserLoginUtil::getUserLoginId()."'");// and status_code in ('R_B_NEW_WAIT_APPROVE_1','R_B_NEW_WAIT_APPROVE_2') ");
// 		$criteria->addCondition(" (approver1 = '".UserLoginUtil::getUserLoginId()."' and status_code ='R_B_NEW_WAIT_APPROVE_1') OR (approver2 = '".UserLoginUtil::getUserLoginId()."' and status_code = 'R_B_NEW_WAIT_APPROVE_2')");
		$criteria->addCondition(" approver1 = '".UserLoginUtil::getUserLoginId()."'   OR approver2 = '".UserLoginUtil::getUserLoginId()."' ");
