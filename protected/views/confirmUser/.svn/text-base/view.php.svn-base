...
<table class="simple-form">
	...
	<tr>
		...
		<td class="column-right"><?php echo $model->user_information->personal_card_id ?>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		echo CHtml::link('Back',array('ConfirmUser/'), array('class' => 'button_link')).'&nbsp;'; echo
		CHtml::link('Active User',array('ConfirmUser/Active','id'=>$model->id), array('class' => 'button_link')); ?>
		</td>
	</tr>
</table>
