...
<div>
	...
	<table class="simple-form">
		<tr>
			...
			<td class="column-right"><?php echo $form->textField(RequestServiceType::model(), 'name', array('size' => 20, 'maxlength' => 255)); ?>
			</td>
		</tr>
		<tr>
			<td class="column-left">Description</td>
			<td class="column-right"><?php echo $form->textArea(RequestServiceType::model(), 'description', array('size' => 20, 'maxlength' => 255)); ?>
			</td>
		</tr>
		<tr>
