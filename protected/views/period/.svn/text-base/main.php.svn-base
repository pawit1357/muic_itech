<div class="module-head">Period</div>
<div>
	<?php 
	...
	<table class="items">
		...
		?>
			...
			<td class="center"><?php echo GridUtil::getDataIndex($dataProvider, $counter++)?></td>
				<td class="center"><?php echo $data->period_group->name?></td>
				<td class="center"><?php echo $data->name?></td>
				
				<td class="center"><a title="View" class="ico-s-view"
					href="<?php echo Yii::app()->CreateUrl('Period/view/id/'.$data->id)?>"></a>
					<a title="Edit" class="ico-s-edit"
					href="<?php echo Yii::app()->CreateUrl('Period/update/id/'.$data->id)?>"></a>
					<a title="Delete"
					onclick="return confirm('Are you sure to delete?')"
					class="ico-s-delete"
					href="<?php echo Yii::app()->CreateUrl('Period/delete/id/'.$data->id)?>"></a>
				</td>
			</tr>
			<?php 
		}
