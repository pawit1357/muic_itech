		...
		<td colspan="2"><br>
			...
			<form action="" method="post">
				<fieldset>
					...
					<div id="equipmentListDelete"></div>
					<div id="equipmentList">
						...
						<div
							...
							<div class="item-detail-manage">
								<a
									href="javascript:deleteEq('<?php echo $requestBorrowEquipmentType->equipment_type_list->id?>')">
								</a>
							</div>
							<div class="clear"></div>
							<div
					...
					<div class="eq-detail-p" id="eq-other-device">
						<div class="item-detail-left">Other Device & Notes</div>
