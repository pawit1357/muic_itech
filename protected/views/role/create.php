...
<div>
	...
	<table class="simple-form">
		<tr>
			...
			<td class="column-right"><?php echo $form->textField(Role::model(), 'name', array('size' => 20, 'maxlength' => 255)); ?>
			</td>
		</tr>
		<tr>
			<td class="column-left">Description</td>
			<td class="column-right"><?php echo $form->textArea(Role::model(), 'description', array()); ?>
			</td>
		</tr>
		<tr>
