...
//                     $_SESSION['FAIL_MESSAGE'] ='<span class="label label-block label-danger">xxxxxxxxxxxxxxxxx</span><br>';
...
//                     $_SESSION['FAIL_MESSAGE'] ='<span class="label label-block label-danger">yyyyyyyyyyyyyy</span><br>';
                    // --------- check student. ---------
                    // connect to server
            ...
            } else if ($username == 'pawit1357') {
                // --------- bypass role student for test. ---------
                $criteria = new CDbCriteria();
                $criteria->condition = "username = '" . $username . "' and password = md5('" . $password . "')";
                $userLogin = UserLogin::model()->findAll($criteria);
                if (isset($userLogin[0])) {
